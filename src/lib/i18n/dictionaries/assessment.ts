...
const assessment = {
  th: {
    ...
    result: {
      ...
      shareActionTitle: "Goodfill Care — ผลประเมินเวลเนสของฉัน",
      shareActions: {
        facebook: "แชร์ไปยัง Facebook",
        instagram: "แชร์ไปยัง IG Story",
        line: "แชร์ไปยัง LINE",
        copy: "คัดลอกลิงก์",
      ...
      publicShare: {
        ...
        lead: "นี่คืออาร์คีไทป์เวลเนสบนเกาะสมุยที่สะท้อนจังหวะการฟื้นพลัง วิธีพัก และแกนเด่นของตัวตน",
        codeEyebrow: "รหัสอาร์คีไทป์",
        compassTitle: "แกนบุคลิกเวลเนส",
        shareTitle: "แชร์คาแรกเตอร์นี้",
        shareLead: "ส่งต่อให้คนที่คุณอยากชวนมาค้นหาจังหวะกายใจของตัวเอง",
        cta: "ทำแบบประเมินของคุณ",
        packagesCta: "ดูแพ็กเกจเวลเนส",
      },
  ...
  en: {
    ...
    result: {
      ...
      shareActionTitle: "Goodfill Care — My wellness assessment result",
      shareActions: {
        facebook: "Share to Facebook",
        instagram: "Share to IG Story",
        line: "Share to LINE",
        copy: "Copy link",
        copied: "Link copied",
      ...
      publicShare: {
        ...
        lead: "This Samui wellness archetype reflects a recovery rhythm, preferred way to rest and the compass points that shape this character.",
        codeEyebrow: "Archetype code",
        compassTitle: "Wellness personality axes",
        shareTitle: "Share this character",
        shareLead: "Send it to someone you would invite to discover their own body-and-mind rhythm.",
        cta: "Take your assessment",
        packagesCta: "Explore wellness packages",
      },
